-- WordPress-Style Role System Migration (Safe Version)
-- Version: 0.2.1
-- Date: 2025-11-06
...
-- ============================================================================
-- PART 4: Update Row Level Security Policies (DROP ALL FIRST)
-- ============================================================================

-- Drop ALL existing policies (prevents "already exists" errors)
...
CREATE VIEW public.user_capabilities AS
SELECT
  id,
  email,
  role,
...
-- View capabilities for your user
SELECT * FROM public.user_capabilities WHERE email = 'malsicario@malsicario.com';
